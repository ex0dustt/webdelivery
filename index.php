            ...
            <div class="col-md-12">
                <div id="main-slider">
                    ...
                    while ($slider=$q_slider->fetch_assoc()) {
                        ?>
                        <div class="item">
                            <img src="foto_produk/<?php echo $slider['foto_produk']; ?>" style="height:385px;width:1200px;" class="img-responsive">
                        </div>
                        <?php
                    }
                    ?>  
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Menu Makanan Yang Lengkap</h3>
                    <p>beragam pilihan menu makanan dan minuman yang anda sukai.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di warung-warung yang telah bekerja sama</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© Kelompok 2</p>
        </div>
        <div class="col-md-6">
            <p class="pull-right">Tugas Webprog
            </p>
        </div>
    </div>
</div>
